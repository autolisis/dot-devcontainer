if not set -q abbrs_initialized
    ...
    abbr dot 'git --git-dir=$HOME/.dot/.git --work-tree=$HOME'
    abbr dota 'git --git-dir=$HOME/.dot/.git --work-tree=$HOME add'
    abbr dotc 'git --git-dir=$HOME/.dot/.git --work-tree=$HOME commit -s -m'
    abbr dotp 'git --git-dir=$HOME/.dot/.git --work-tree=$HOME push origin'
    abbr dots 'git --git-dir=$HOME/.dot/.git --work-tree=$HOME status'
    abbr du 'du -hs'
